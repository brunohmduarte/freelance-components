...
-- Dumping structure for table freelance.users
CREATE TABLE IF NOT EXISTS `users` (
  `user_id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `email` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT '',
  `password` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `role` enum('admininstrator','user') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
